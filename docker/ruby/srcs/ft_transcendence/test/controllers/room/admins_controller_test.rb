...
class Room::AdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_admin" do
    assert_difference('Room::Admin.count') do
      post room_admins_url, params: { room_admin: { room_id: @room_admin.room_id, user_id: @room_admin.user_id } }
    end
  ...
  test "should update room_admin" do
    patch room_admin_url(@room_admin), params: { room_admin: { room_id: @room_admin.room_id, user_id: @room_admin.user_id } }

class Room::AdminsController < ApplicationController
	...
	def create
		...
		respond_to do |format|
			if @room_admin.save
				format.html { redirect_to room_admins_url, notice: 'Admin was successfully created.' }
			else
	...
	private
		...
		def is_owner
			redirect_to @room, :alert => "Missing permission" and return unless @room.owner == current_user
		end
